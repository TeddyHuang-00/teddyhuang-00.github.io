...
export const Yes = () => (
  <Icon name="tabler:check" class="mx-auto text-emerald-600 dark:text-emerald-500" />
);

export const No = () => <Icon name="tabler:x" class="mx-auto text-red-600 dark:text-red-500" />;
